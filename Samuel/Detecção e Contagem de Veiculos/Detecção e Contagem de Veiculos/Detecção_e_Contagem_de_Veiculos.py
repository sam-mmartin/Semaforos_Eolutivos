...
while True:
    ...
    #obtem a diferenca absoluta entre frame inicial e frame atual (subtracao de background)
    #faz a binarizacao do frame com background subtraido 
    ...
    #faz a dilatacao do frame binarizado, com finalidade de elimunar "buracos"
    #Dessa forma, objetos detectados serao considerados uma "massa" de cor preta 
    #encontra os contornos apos dilatacao.
    ...
    for c in cnts:
        ...
        #contabiliza numero de contornos encontrados
        QtdeContornos = QtdeContornos+1    

        #obtem coordenadas do contorno
        ...
        #contabiliza quais contornos cruzaram quais linhas (num determinado sentido)
    ...
    #Aperte ESC para fechar a aplicacao
